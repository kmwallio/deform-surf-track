function [ xO, yO ] = blender( xM, yM, nodeXO, nodeYO, aO, bO, cO, alphasO, nodeX, nodeY, a, b, c, alphas )
%BLENDER Summary of this function goes here
%   Detailed explanation goes here
    
    [xO, yO] = arrayfun(@my_blend_map, xM, yM);

    function [ x, y ] = my_blend_map( xS, yS )
